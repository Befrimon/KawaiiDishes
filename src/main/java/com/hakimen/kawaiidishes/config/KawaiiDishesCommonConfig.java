...
public class KawaiiDishesCommonConfig {
    public static final ModConfigSpec.Builder commonConfigBuilder = new ModConfigSpec.Builder();
    public static final ModConfigSpec commonSpec;
    public static final ModConfigSpec.BooleanValue shouldMobSpawnWithDress;
    public static final ModConfigSpec.DoubleValue chanceToSpawnWithDress;

    public static final ModConfigSpec.DoubleValue chanceToMessage;
    public static final ModConfigSpec.BooleanValue shouldSendMessage;

    public static final ModConfigSpec.BooleanValue wanderingTraderTrades;
    public static final ModConfigSpec.BooleanValue villagerTrades;
    public static final ModConfigSpec.DoubleValue chanceToDropArmorSet;

    public static final ModConfigSpec.IntValue villageStructWeight;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> messages;
